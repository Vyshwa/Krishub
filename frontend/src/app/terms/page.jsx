...
export const metadata = {
  ...
  description: 'KrishTech Computers terms of service — conditions for using our website, software products (Renote, Reveal, ReGen), and IT services.',
  alternates: { canonical: 'https://krishub.in/terms' },
  openGraph: {
    title: 'Terms of Service — KrishTech Computers',
    description: 'Read our terms and conditions for using KrishTech services.',
    url: 'https://krishub.in/terms',
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using the services provided by KrishTech Computers (&ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;us&rdquo;),
