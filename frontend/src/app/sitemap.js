export default function sitemap() {
  const baseUrl = 'https://krishub.in';

  const routes = [
    { url: baseUrl, lastModified: new Date(), changeFrequency: 'weekly', priority: 1 },
    { url: `${baseUrl}/about`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/software`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${baseUrl}/amc`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
