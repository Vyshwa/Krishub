...
export const metadata = {
  ...
  description: 'KrishTech Computers privacy policy — how we collect, use, store, and protect your personal information and data across our services and platform.',
  alternates: { canonical: 'https://krishub.in/privacy' },
  openGraph: {
    title: 'Privacy Policy — KrishTech Computers',
    description: 'Learn how KrishTech Computers handles your data and protects your privacy.',
    url: 'https://krishub.in/privacy',
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                KrishTech Computers (&ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;us&rdquo;) collects information you provide when using our website and services, including:
              </p>
