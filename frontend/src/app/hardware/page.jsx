...
export const metadata = {
  ...
  description: 'Quality IT hardware products and professional services by KrishTech — computers, laptops, peripherals, storage, components, and expert repair & maintenance.',
  alternates: { canonical: 'https://krishub.in/hardware' },
  openGraph: {
    title: 'Hardware Services — KrishTech Computers',
    description: 'Quality hardware products with professional sales, service, and technical support.',
    url: 'https://krishub.in/hardware',
    ...
    <div className="flex flex-col">
      ...
      <section className="py-12 bg-muted/30">
        <div className="container">
            ...
            <img src="/assets/hardware_opt.webp" alt="KrishTech professional IT hardware equipment and services" width={800} height={600} loading="lazy" className="rounded-lg shadow-xl w-full" />
          </div>
        </div>
      </section>
