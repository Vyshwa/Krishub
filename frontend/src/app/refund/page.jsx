...
export const metadata = {
  title: 'Refund Policy',
  description: 'KrishTech Computers refund policy — hardware returns within 7 days, software subscription refunds, service cancellation guidelines, and dispute resolution process.',
  alternates: { canonical: 'https://krishub.in/refund' },
  openGraph: {
    title: 'Refund Policy — KrishTech Computers',
    description: 'Understand our refund policies for hardware, software, and services.',
    url: 'https://krishub.in/refund',
