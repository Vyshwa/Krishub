...
export const metadata = {
  title: 'About Us',
  description: 'Learn about KrishTech Computers — a leading IT solutions provider in Coimbatore specializing in hardware, software, and enterprise technology services.',
  alternates: { canonical: 'https://krishub.in/about' },
  openGraph: {
    title: 'About Us — KrishTech Computers',
    description: 'Building trust through technology excellence and exceptional client service.',
    url: 'https://krishub.in/about',
        ...
        <div className="container">
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            <div className="relative">
              <img src="/assets/KrishTech Home.jpg" alt="KrishTech Computers office and team" width={803} height={399} loading="lazy" className="rounded-lg shadow-xl" />
            </div>
          </div>
        </div>
      </section>
