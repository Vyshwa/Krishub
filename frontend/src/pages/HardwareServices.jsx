...
import logoImg from '@/assets/hardware_opt.webp';
    ...
    <div className="flex flex-col">
      ...
      <section className="py-12 bg-muted/30">
        <div className="container">
            ...
            <img src={logoImg} alt="KrishTech professional IT hardware equipment and services" width={800} height={600} loading="lazy" className="rounded-lg shadow-xl w-full" />
          </div>
        </div>
      </section>
